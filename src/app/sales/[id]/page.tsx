...
export default function SalesDetailPage() {
  ...
  return (
    <DashboardLayout>
      <div className="space-y-6 bg-gray-100 dark:bg-gray-900 min-h-screen">
        {/* ヘッダー */}
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  ...
                  {sales.client.email && (
                    <div>
                      ...
                      <div className="font-medium">{sales.client.email}</div>
                    </div>
                  )}
                  {sales.client.phone && (
                    <div>
                      <div className="text-sm text-gray-500">電話番号</div>
                      <div className="font-medium">{sales.client.phone}</div>
                    </div>
                  )}
                </div>
              </div>
